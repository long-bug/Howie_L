...
![1553572597916](F:\Python学习笔记\图片\1553572597916.png)
...
// sessionStorage.setItem("变量名","变量值");  // 也是保存数据
sessionStorage.变量名  // 读取数据
// sessionStorage.getItem("变量名");  // 也是读取数据

sessionStorage.clear()  // 清除所有sessionStorage保存的数据
sessionStorage.removeItem("变量名"); // 删除一个指定变量名对应的数据



localStorage.变量名 = 变量值   // 保存数据
// localStorage.setItem("变量名","变量值");  // 也是保存数据
localStorage.变量名  // 读取数据
// localStorage.getItem("变量名");  // 也是读取数据

localStorage.clear()  // 清除所有localStorage保存的数据
localStorage.removeItem("变量名"); // 删除一个指定变量名对应的数据
```
...
![1553576294430](F:\Python学习笔记\图片\1553576294430.png)

![1553576382897](F:\Python学习笔记\图片\1553576382897.png)



![1553576348110](F:\Python学习笔记\图片\1553576348110.png)



![1553576402354](F:\Python学习笔记\图片\1553576402354.png)
...
![1553578068434](F:\Python学习笔记\图片\1553578068434.png)
...
```
ACCOUNT SID：8a216da86dd47cb4016f16a587dc0501
...
![1553677987640](F:\Python学习笔记\图片\1553677987640.png)



在开发过程中,为了节约发送短信的成本,可以把自己的或者同事的手机加入到测试号码中.

![1553678528811](F:\Python学习笔记\图片\1553678528811.png)
